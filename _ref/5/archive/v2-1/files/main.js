...
function drawTitleScreen() {
  ...
  const pulse = 0.6 + 0.4 * Math.sin(now * 3e-3);
...
function drawInstructionScreen() {
  ...
  drawShape(ctx, "rectangle" /* RECTANGLE */, appData.canvasWidth * 0.75, 180, 50, "#4A90D9", 0, 0.7);
  drawShape(ctx, "triangle" /* TRIANGLE */, appData.canvasWidth * 0.82, 260, 50, "#F5D547", 0.3, 0.7);
  drawShape(ctx, "circle" /* CIRCLE */, appData.canvasWidth * 0.78, 340, 50, "#E74C3C", 0, 0.7);
  const pulse = 0.5 + 0.5 * Math.sin(Date.now() * 3e-3);
  ctx.font = "18px sans-serif";
  ctx.textAlign = "center";
...
var targetIntersections, assetListData, nextCloneId, currentState, appData, textData, appCanvas, ctx, uiLayer, clonedShapes, paletteShapes, dropZones, selectedShape, draggingShape, isDraggingFromPalette, isRotating, dragOffsetX, dragOffsetY, rotationStartAngle, shapeStartAngle, currentBubbleText, currentPuzzleIndex, animFrameId, uiElements, soundsInitialized;
var init_app = __esm({
  "public/20260401183100_f1bbc072-ea26-42d7-a4eb-8de16f4caed3/app.ts"() {
    init_appHelper();
    init_gsap();
